...
class HoldOutSelector:
    ...
    def _model_selection_helper(self, dataset_getter, experiment_class, config, exp_config_name,
        ...
        selection_dict['TR_acc'] = float(training_acc)
        selection_dict['VL_acc'] = float(validation_acc)

        logger.log('TR Accuracy: ' + str(training_acc) + ' VL Accuracy: ' + str(validation_acc))
